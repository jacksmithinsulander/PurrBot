...
mod tests {
    ...
    fn test_logged_out_operations_not_default() {
        ...
        assert!(
            ...
            "logged_out_operations should not return an empty keyboard"
        );
        assert_ne!(
            keyboard.inline_keyboard.len(),
            default_keyboard.inline_keyboard.len()
        );
    }
    ...
    fn test_logged_in_operations_not_default() {
        ...
        assert!(
            !keyboard.inline_keyboard.is_empty(),
            "logged_in_operations should not return an empty keyboard"
        );
        assert_ne!(
            keyboard.inline_keyboard.len(),
            default_keyboard.inline_keyboard.len()
    ...
    fn test_logged_in_operations_structure() {
        ...
        assert_eq!(
            keyboard.inline_keyboard[1].len(),
            2,
