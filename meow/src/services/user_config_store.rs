...
mod tests {
    ...
    async fn test_insert_and_get_config() {
        ...
        // Insert config
        store.insert_or_update_config(TEST_USER_ID, TEST_CONFIG_JSON).await.unwrap();
    ...
    async fn test_update_existing_config() {
        ...
        // Update config
        store.insert_or_update_config(TEST_USER_ID, UPDATED_CONFIG_JSON).await.unwrap();
    ...
    async fn test_multiple_users() {
        ...
        store.insert_or_update_config(TEST_USER_ID, TEST_CONFIG_JSON).await.unwrap();
        store.insert_or_update_config(TEST_USER_ID_2, TEST_CONFIG_JSON_2).await.unwrap();
    ...
    async fn test_empty_config_json() {
        ...
        // Insert empty JSON
        store.insert_or_update_config(TEST_USER_ID, EMPTY_CONFIG_JSON).await.unwrap();
    ...
    async fn test_special_characters_in_user_id() {
        ...
        store.insert_or_update_config(SPECIAL_CHARS_USER_ID, TEST_CONFIG_JSON).await.unwrap();
    ...
    async fn test_very_long_user_id() {
        ...
        store.insert_or_update_config(VERY_LONG_USER_ID, TEST_CONFIG_JSON).await.unwrap();
    ...
    async fn test_concurrent_access() {
        ...
        for i in 0..5 {
            ...
            let handle = tokio::spawn(async move {
                store_clone.insert_or_update_config(&user_id, &config_json).await.unwrap();
    ...
    async fn test_large_config_json() {
        ...
        // Insert large config
        store.insert_or_update_config(TEST_USER_ID, &large_json).await.unwrap();
    ...
    async fn test_sql_injection_safety() {
        ...
        let result = store.insert_or_update_config(malicious_user_id, TEST_CONFIG_JSON).await;
        assert!(result.is_ok());
